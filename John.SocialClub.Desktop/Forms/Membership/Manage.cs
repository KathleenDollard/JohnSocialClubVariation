...
namespace John.SocialClub.Desktop.Forms.Membership
{
    ...
    public partial class Manage : Form
    {
        ...
        {            
            ...
            {
                AddErrorMessage(Resources.Registration_Occupation_Select_Text);
            }

            if (cmbMaritalStatus.SelectedIndex == -1)
            {
                AddErrorMessage(Resources.Registration_MaritalStatus_Select_Text);
            }

            if (cmbHealthStatus.SelectedIndex == -1)
            {
                AddErrorMessage(Resources.Registration_HealthStatus_Select_Text);
            }
        ...
        private bool SetupPrinting(bool isPrint)
        {
            ...
            PrintReport.DocumentName = "MembersReport";
            PrintReport.PrinterSettings = printDialog.PrinterSettings;
            PrintReport.DefaultPageSettings = printDialog.PrinterSettings.DefaultPageSettings;
            PrintReport.DefaultPageSettings.Margins = new Margins(40, 40, 40, 40);
            dataGridViewPrinter = new DataGridViewPrinter(dataGridViewMembers, PrintReport, true, true, Resources.Report_Header, new Font("Tahoma", 13, FontStyle.Bold, GraphicsUnit.Point), Color.Black, true);
            return true;
        }
        ...
        private void Register_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ValidateRegistration())
                {
                    ...
                    var success = clubMemberService.RegisterClubMember(clubMemberModel);
        ...
        private void Tab_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataTable data = clubMemberService.GetAllClubMembers();
                    InitializeUpdate();
        ...
        private void Search_Click(object sender, EventArgs e)
        {
            try
            {
                DataTable data = clubMemberService.SearchClubMembers(cmbSearchOccupation.SelectedValue, cmbSearchMaritalStatus.SelectedValue, cmbOperand.GetItemText(cmbOperand.SelectedItem));
                LoadDataGridView(data);
            }
            catch (Exception ex)
            {
        ...
        private void PrintDocument_PrintPage(object sender, PrintPageEventArgs e)
        {
            try
            {
                bool hasMorePages = dataGridViewPrinter.DrawDataGridView(e.Graphics);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                if (ValidateUpdate())
                {
                    ...
                    var flag = clubMemberService.UpdateClubMember(clubMemberModel);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                var flag = clubMemberService.DeleteClubMember(memberId);
